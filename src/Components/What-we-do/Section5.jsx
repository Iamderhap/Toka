...
const Section5 = () => {
  ...
  return (
    <>
      <div className='lg:flex lg:items-center lg:gap-[90px] flex flex-col items-center bg-[rgba(0,255,255,0.03)] py-[50px]'>
          <div className='lg:flex-row flex flex-col justify-center items-center gap-[50px]'>
                <div className='lg:flex flex flex-col gap-[20px] lg:gap-[10px] lg:w-[40vw] w-[85vw]'> 
                      <div>
                          <img className=' lg:w-[50vw] w-[85vw] rounded-[20px] lg:rounded-t-[20px] h-[35vh]' src="/businesspeople.png" alt="business people image" />
                      </div>
                        <div className='lg:flex-row flex flex-col lg:gap-[10px] gap-[20px]'>
                 ...
                 <div className='lg:flex flex flex-col items-center lg:flex-col lg:py-[80px] gap-[20px] '>
                      ...
                      <p className='font-bold text-[35px] lg:text-[45px] lg:w-[25vw] w-[80vw]'>Millions of users around the world</p>
            ...
            <div className='lg:flex-row flex flex-col gap-[10vw] lg:gap-[5vw] text-center pt-[50px]'>
